...
File reportfile = new File(application.getRealPath("//reportes//reporte_libros.jasper"));
...
response.setHeader ("Content-disposition", "inline; filename=Reporte General Libros.pdf");
